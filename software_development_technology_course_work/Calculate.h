...
namespace COURSE_WORK {
    ...
    public:                                                 /* PUBLIC SECTIONS */
        ...
        constexpr void start() noexcept {
            ...
            BENCHMARK::BenchMark start{};                           /* НАЧАЛО ЗАМЕРА ВРЕМЕНИ РАБОТЫ ПРОГРАММЫ */
            ...
            BENCHMARK::BenchMark end{};                             /* КОНЕЦ ЗАМЕРА ВРЕМЕНИ РАБОТЫ ПРОГРАММЫ */

            showBenchmark(start, end);                              /* ВЫВОД В БУФЕР РЕЗУЛЬТАТА ЗАМЕРА */
